    ...
    <footer className="py-16 md:py-24 border-t border-border">
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground leading-relaxed max-w-sm">
              Студия иллюстраций — создаю персонажей, концепты и арт любой сложности. Каждая работа уникальна.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              ...
              <li>
                <a href="#constructor" className="hover:text-foreground transition-colors">
                  Конструктор
                </a>
              </li>
              <li>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row md:items-center justify-between gap-4 text-sm text-muted-foreground">
          <p>© 2026 Студия иллюстраций. Все права защищены.</p>
